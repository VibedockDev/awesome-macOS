...
|- [Vibedock](https://vibedock.dev) - A native macOS dashboard for managing Claude Code MCP servers. Configure, monitor, and organize your MCP server fleet in one-click.
